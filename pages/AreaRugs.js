      ...
      <article className="flex flex-col justify-center w-9/12 mx-auto mb-16 items-start mt-15vh">
        ...
        <div style={{ position: 'relative', width: '100%', height: '640px' }}>
          <Image
            alt="Mountains"
            className="rounded"
            src="/images/carpets/area-rug-1.jpg"
            layout="fill"
            objectFit="cover"
          />
        </div>
        <div className="prose dark:prose-dark max-w-none w-full mt-12">
          <p>
            The first important professional method to clean your carpet is
            Steam cleaning. Here we are using the steam of detergent solution to
            clean the carpets. To employ Steam cleaning method we need to have a
            truck mount unit that has rotary brushes which apply hot steam in to
            the carpet and remove dust and soil. The success of steam cleaning
            rely on the technicians experience and skill with the quality of
            truck mount machine.The machine should keep the detergent solution
            in a proper temperature to get steam continuously and the pressure
            of steam spraying should be controllable at any time. When the hot
            steam applied on the carpet the soil and dust particles on the
            carpet will be removed. It is very easy to clean the removed soil
            particle from the carpet.
          </p>
          <p>
