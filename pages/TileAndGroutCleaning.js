    ...
    <>
      ...
      <article className="relative max-w-3xl mx-auto px-6 prose lg:prose-lg theme-text">
        ...
        <div className="flex flex-col ">
          ...
          <div className="aspect-w-1 aspect-h-1 my-12">
            <img src="/images/tile/kitchen-tile-cleaning-1.jpg" alt="" />
          </div>
          <h2 className="content-title">Tile and Grout Cleaning Process</h2>
          <p>
            We first apply a non-toxic cleaner to your tile and grout to break
            up any dirt or grease stuck in the grout. We then deep clean your
            tile and grout with high-speed machine that scrubs and extracts the
            dirt from your tile and grout.
          </p>
          <div className="aspect-w-1 aspect-h-1 my-12">
            <img src="/images/tile/kitchen-tile-cleaning-2.jpg" alt="" />
          </div>
          <p>
          ...
          <div className="aspect-w-1 aspect-h-1 my-12">
            <img src="/images/tile/shower-tile-cleaning-1.png" alt="" />
          </div>
          <div className="aspect-w-1 aspect-h-1 my-12">
            <img src="/images/tile/shower-tile-cleaning-2.jpeg" alt="" />
          </div>
        </div>
        ...
        {/* <p>
          ...
          before!
          Once the surface is completely
            clean we will apply our grout sealant to protect your floors from
            future spills and grime.
        </p> */}
