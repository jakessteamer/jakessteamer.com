            ...
            <article className="flex flex-col justify-center w-9/12 mx-auto mb-16 items-start mt-15vh">
                ...
                <div className="prose dark:prose-dark max-w-none w-full mt-12">
                    ...
                    <p>
                        ...
                        vacuum power to remove the dirt that homeowners can't. We complete the job
                        with a high-pressure rinse.After cleaning your tile and grout, our
                        professional technicians will apply a penetrating sealer to protect grout
                        against mildew and staining for up to two years. And basic Grout Cleaning
                        isn't the only service we provide. If you have colored grout in your kitchen
                        or bathroom or between other tile surfaces, Jake’s steamer Tile Cleaning
                        service will safely get ceramic and porcelain tiled surfaces sparkling
                        again! And if your tile is made of natural material such as granite, marble,
                        slate, travertine or Saltillo, no problem!
                    </p>
                </div>
            </article>
        </>
