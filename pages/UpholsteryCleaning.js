            ...
            <article className="flex flex-col justify-center w-9/12 mx-auto mb-16 items-start mt-15vh">
                ...
                <div className="prose dark:prose-dark max-w-none w-full mt-12">
                    ...
                    <p>
                        ...
                        considered as great investments that add to a household. Like any other
                        investment, they should be taken cared of, since they will only remain
                        beautiful as long as we do our part in making sure that they remain
                        beautiful.
                    </p>
                    <h1>
                        Here are tips to make sure that your upholstery remains clean and beautiful.
                    </h1>
                    <p>
                        Prevention is always the best maintenance for anything, and that includes
                        upholstery! Keep it safe from any spills or sharp objects. When you are
                        sitting or lying down on your upholstered furniture, remember to refrain
                        from doing any motion that can stretch the fabric, such as sudden stretching
                        or kicking.
                    </p>
                </div>
            </article>
