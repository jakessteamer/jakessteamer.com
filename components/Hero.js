...
export default function Hero() {
    return (
        <section className="flex flex-col justify-evenly  text-center gap-y-64 h-screen w-full">
            <Image
            ...
            <h1 className="z-10 text-4xl sm:text-6xl lg:text-7xl mt-32  leading-none font-extrabold tracking-tight hero-headline ">
