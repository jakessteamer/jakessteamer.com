          ...
          <div className="flex flex-wrap -m-4">
            <div className="xl:w-1/4 md:w-1/2 p-4">
              <div className="bg-gray-100 p-6 rounded-lg">
                ...
                <p className="leading-relaxed text-base">
                  ...
                  carpets. Our customers trust us with their homes and
                  businesses and in return we have guarenteed piece of mind and
                  100% satisfaction.
                </p>
            ...
            <div className="xl:w-1/4 md:w-1/2 p-4">
              <div className="bg-gray-100 p-6 rounded-lg">
                ...
                <p className="leading-relaxed text-base">
                  There are dozens of home cleaning solutions and retail
                  products designed to clean tile and flooring. While these
                  products can provide short-term results, they can also cause
                  unseen damage and allow residue, dirt and grime to build-up
                  over time. A periodic professional cleaning is the best
                  solution to protect and enhance your floors.
                </p>
            ...
            <div className="xl:w-1/4 md:w-1/2 p-4">
              <div className="bg-gray-100 p-6 rounded-lg">
                ...
                <p className="leading-relaxed text-base">
                  From leaking faucets to broken water heaters to flooding,
                  water damage is one of the most common and potentially
                  destructive problems you can face as a homeowner. In water
                  damage situations it is important to act immediately. We have
                  the tools to extract all the water and dry the area. We finish
                  the process with sanitizing and deodorizing leaving your
            ...
            <div className="xl:w-1/4 md:w-1/2 p-4">
              <div className="bg-gray-100 p-6 rounded-lg">
                ...
                <p className="leading-relaxed text-base">
                  Air duct cleaning can drasticially improve indoor air quality
                  by removing bacteria, mold, and mildew spores. We use an EPA
